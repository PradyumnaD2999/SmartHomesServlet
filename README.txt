...
2. Copy the content of creation_mysql.sql file from Assignment_3 folder in query tool and run it to create database and tables.

How to compile java code:
1. Go to Assignment_3 > WEB-INF > classes and open command prompt at this path.
