...
public class AjaxUtility {
	...
	public static HashMap<String,Product> getData()
	{
		...
		try
		{
			...
			while(rs.next())
			{	Product p = new Product(rs.getString("Id"),rs.getString("productName"),rs.getDouble("productPrice"),rs.getString("productImage"),rs.getString("productManufacturer"),rs.getString("productCondition"),rs.getString("ProductType"),rs.getString("description"),rs.getDouble("productDiscount"));
	...
	public static void storeData(HashMap<String,Product> productdata)
	{
		try
		{
			...
			String insertIntoProductQuery = "INSERT INTO products(productId,productName,image,retailer,productCondition,productPrice,productType,discount,description) "
			+ "VALUES (?,?,?,?,?,?,?,?,?);";	
			...
			{	
                ...
                pst.setString(8,entry.getValue().getDescription());
				pst.execute();
			}
		}
		catch(Exception e)
