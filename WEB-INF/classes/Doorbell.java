...
public class Doorbell extends HttpServlet{
	private String id;
	private String name;
	...
	public Doorbell(String name, double price, String description, String image, String retailer, String condition, double discount){
		// this.id=id;
		this.name=name;
		this.price=price;
