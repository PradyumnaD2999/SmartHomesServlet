		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'>"
                                                        +"<option value='dbl' selected>Doorbell</option>"
                                                        +"<option value='dlk'>Doorlock</option>"
                                                        +"<option value='spkr'>Speaker</option>"
                                                        +"<option value='lght'>Lighting</option>"
                                                        +"<option value='trmst'>Thermostat</option>"
					+ "</td></tr><tr><td>"
					...
					+ "</td></tr><tr><td>"
                    + "<h3>Product Description</h3></td><td><input type='text' name='desc' value='' class='input' required></input>"
					+ "</td></tr><tr><td>"
