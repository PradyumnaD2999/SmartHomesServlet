...
public class ProductAdd extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		out.println("<form action=\"ProductAdd\" >");
        out.println("<div class='form-group'><label>Category:</label></br>"
		...
		out.println("<button  data-toggle='modal' data-target='#myModal1' class='btn btn-primary'>Add</button></div>");
		...
		out.println("<div class='modal-body'><p>Product Added</p></div><div class='modal-footer'><button type='button' class='btn btn-default' data-dismiss='modal'>Close</button></div></div></div></div>");
	}
}