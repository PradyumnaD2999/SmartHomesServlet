...
public class Login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if(user!=null)
		{
		 ...
		 String user_type = user.getUsertype();
		 	...
		 	if (usertype.equals(user_type) && password.equals(user_password)) 
			{
				...
				if(usertype.equals("retailer")) {
					...
					session.setAttribute("username", user.getName());
					session.setAttribute("usertype", user.getUsertype());
					response.sendRedirect("HomeRetailer");
					return;
				}
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Login'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>User Type</h3></td><td><select name='usertype' class='input'><option value='customer' selected>Customer</option><option value='retailer'>Salesman</option><option value='manager'>Store Manager</option></select>"
				+ "</td></tr><tr><td></td><td>"
